...
public abstract class ACard {
    ...
    public ACard(int valid) {
        ...
        this.nullIcon = new ImageIcon("src/flatIcon/null_bg.png");
    ...
    // set lại hình chơi theo màn (thêm nhiều hình hơn)
    ...
    // set lại kích thước của thẻ theo màn chơi (thêm nhiều hình hơn)
    ...
    // lấy hình chưa lật
    public ImageIcon getBgrIcon() {
        return bgrIcon;
    }

    // kiểm tra thẻ có giá trị chưa lật và có thể lật
