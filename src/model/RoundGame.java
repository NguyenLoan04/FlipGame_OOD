...
public class RoundGame implements IRoundGame{
    ...
    public RoundGame(int level) {
        ...
        // lấy ngẫu nhiên các hình từ danh sách hình (vửa đủ số lượng hình)
        iconIndex(this.x*this.y/2);
        // tạo ma trận valid hình
        createMatrix();
        // tạo ma trận các thẻ model
        createCards();
    }
